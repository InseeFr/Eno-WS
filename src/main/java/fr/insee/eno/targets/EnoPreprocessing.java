 ...
 * into .xsl files then incorporates them in the appropriate .xsl stylesheets
 * (used later in DDIPreprocessing and ddi2fr)
 * 
 * @author gerose
 *
 */
public class EnoPreprocessing {

	final static Logger logger = Logger.getLogger(EnoPreprocessing.class);

	private static XslTransformation saxonService = new XslTransformation();
	private static CleanFolder cleanService = new CleanFolder();
