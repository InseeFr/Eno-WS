...
public class DDIToFOImpl implements DDIToFO {
    ...
    private static final Logger logger = LogManager.getLogger(DDIToFOImpl.class);
    ...
    private String transform(File file, Map<String, Object> params) throws Exception {
        ...
        try {
            ...
            GenerationService genService = new GenerationService(new DDIPreprocessor(), new DDI2PDFGenerator(), new NoopPostprocessor());
